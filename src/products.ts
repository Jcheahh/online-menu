...
const products: Product[] = [
    {
        ...
        photo: {
            url:
                "https://images.weserv.nl/?url=https://s3-ap-southeast-1.amazonaws.com/v3-live.image.oddle.me/product/5Combo5ChickenChopReadytoCook28b42f.jpg&h=1000&fit=cover",
...
我们将腌制好的食材以真空包装来处理，「一包一次」的分量，方便妈妈们收藏、烹煮和品尝。`,
    ...
    },
    {
        ...
        photo: {
            url:
                "https://images.weserv.nl/?url=https://s3-ap-southeast-1.amazonaws.com/v3-live.image.oddle.me/product/V21Pumpkinslice800gfb20c2.jpg&amp;h=1000&amp;fit=cover",
...
`,
    ...
    },
    {
        ...
        photo: {
            url:
                "https://images.weserv.nl/?url=https://s3-ap-southeast-1.amazonaws.com/v3-live.image.oddle.me/product/V16LimaBeans220ged9a6c.jpg&amp;h=1000&amp;fit=cover",
    ...
    },
    {
        ...
        photo: {
            url:
                "https://images.weserv.nl/?url=https://s3-ap-southeast-1.amazonaws.com/v3-live.image.oddle.me/product/V1FrenchBeanse929df.jpg&amp;h=1000&amp;fit=cover",
...
• 1Pack (250g+-) `,
    ...
    },
    {
        ...
        photo: {
            url:
                "https://images.weserv.nl/?url=https://s3-ap-southeast-1.amazonaws.com/v3-live.image.oddle.me/product/Sinceromultifunction6LpressurecookerSPC9001baee74.jpg&w=500&h=500&fit=cover",
